...
## AI Logic
The Big Bad Wolf makes programmatic decisions based on health thresholds. It acts aggressively when Grandma's health drops, heals/howls defensively when its own health is low, and relies on standard claw swipes for attacks. 

## Known Issues or Limitations
* To be filled out if necessary before submission.
